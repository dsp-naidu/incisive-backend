...
const transporter = nodemailer.createTransport({
  host: process.env.EMAIL_HOST, // GoDaddy SMTP host
...
app.post('/api/contact', async (req, res) => {
  ...
  try {
    ...
    const clientMailOptions = {
      from: `"Contact Form" <${process.env.EMAIL_USER}>`, // From your professional email
      to: process.env.CLIENT_EMAIL, // To your personal inbox
      cc: process.env.EMAIL_USER, // Optional: Keep a copy in your GoDaddy account
      subject: `Incisive | New Contact Form Submission: ${subject}`,
      html: `
    ...
    const userMailOptions = {
      from: `"Incisive Solutions" <${process.env.EMAIL_USER}>`,
      to: email,
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <br>
          <p>Best regards,<br>Incisive Solutions</p>
        </div>
      `,
    };
